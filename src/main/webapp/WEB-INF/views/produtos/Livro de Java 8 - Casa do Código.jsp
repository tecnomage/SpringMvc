...
<title>Livro de Java 8 - Casa do Código</title>
...
<meta property="og:description"
	content="Conceitos simples mas que trazem importantes possibilidades. Durante o livro exploraremos diversos avan&#231;os do Java 8. Sempre com exemplos pr&#225;ticos e apresentando onde utiliz&#225;-los, migrando o c&#243;digo legado do dia a dia para o novo paradigma funcional do Java 8." />
...
<meta property="og:url"
	content="http://www.casadocodigo.com.br/products/livro-java8" />




<meta property="og:image"
	content="http://cdn.shopify.com/s/files/1/0155/7645/products/java8-socialmedia_large.png?v=1411490181" />
...
<meta itemprop="image"
	content="//cdn.shopify.com/s/files/1/0155/7645/t/189/assets/casa-do-codigo.svg?1057931688501172147">

<link rel="alternate" type="application/json+oembed"
	href="http://www.casadocodigo.com.br/products/livro-java8.oembed" />
<script>
//<![CDATA[
      var Shopify = Shopify || {};
      Shopify.shop = "casadocodigo.myshopify.com";
      Shopify.theme = {"name":"Tema CDC - 8e17aa5","id":87135815,"theme_store_id":null,"role":"main"};
...
//<![CDATA[
    (function() {
      function asyncLoad() {
        var urls = ["https:\/\/www.refersion.com\/tracker\/shopify_script_tag\/?shop=casadocodigo.myshopify.com"];
...
<script id="__st">
//<![CDATA[
var __st={"a":1557645,"offset":-7200,"reqid":"4961f6a9-231e-4395-afa0-c6bc70939ce5","pageurl":"www.casadocodigo.com.br\/products\/livro-java8?mc_cid=c94be381d9\u0026mc_eid=b587e62707","u":"e17d6a820c17","p":"product","rtyp":"product","rid":267623393};
//]]>
</script>
<script>
//<![CDATA[
...
<script type="text/javascript" class="analytics">
      ...
      addListener(window, 'load', function(){
        ...
        window.ShopifyAnalytics.lib.track(
          "Viewed Product",
          {"name":"Java 8 Prático: Lambdas, Streams e os novos recursos da linguagem - E-book","price":"39.90","currency":"BRL","sku":"ebook-java8","brand":"Paulo Silveira, Rodrigo Turini","category":"Livro","nonInteraction":true}
        );
...
<script type="text/javascript"
	src="//cdn.shopify.com/s/assets/themes_support/ga_urchin_forms-0826cdefee6590321eb5c0c435eeebf7a8425a5493a9e95059c40e07e069ad52.js"></script>
...
<link rel="canonical"
	href="http://www.casadocodigo.com.br/products/livro-java8" />
</head>
<body>
	...
	<g class="logo-text">
		...
		<div id="navegacaoCabecalho" class="cabecalhoPrincipal-navegacao">
			...
			<a tabindex="2"
				...
				src="//cdn.shopify.com/s/files/1/0155/7645/t/189/assets/search.svg?1057931688501172147"
			...
			</a> <a tabindex="3" href="/cart" title="Ir para sacola de compras"
	...
	<article id="livro-java8" itemscope itemtype="http://schema.org/Book">
			...
			<div class="cabecalhoProduto-tituloEAutor">
				<h1 itemprop="name" class="cabecalhoProduto-titulo">
					<span class="cabecalhoProduto-titulo-principal" role="presentation">
						Java 8 Prático </span> <span class="cabecalhoProduto-titulo-sub"
						role="presentation"> Lambdas, Streams e os novos recursos
						da linguagem </span>
				</h1>
				<span class="cabecalhoProduto-nomeAutor"> Paulo Silveira,
					Rodrigo Turini </span>
			</div>
			...
			<ul class="adicionarAoCarrinho-listaOfertas">
				...
				<li class="adicionarAoCarrinho-oferta" itemprop="offers" itemscope
					...
					for="product-variant-970167977"> <span
						...
						itemprop="category" itemscope itemtype="http://schema.org/Ebook">
							<span class="adicionarAoCarrinho-tipoDaOferta-nome">
								E-book </span> <small class="adicionarAoCarrinho-tipoDaOferta-detalhe">
								(.pdf, .epub e .mobi) </small>
					...
					<button class="adicionarAoCarrinho-botaoComprar" type="submit"
						name="id" value="970167977" title="Compre o E-book">
						Comprar</button></li>
				...
				<li class="adicionarAoCarrinho-oferta" itemprop="offers" itemscope
					...
					for="product-variant-970168053"> <span
						...
						itemtype="http://schema.org/Hardcover"> <span
							class="adicionarAoCarrinho-tipoDaOferta-nome"> Impresso </span>

					</span>
						<p class="adicionarAoCarrinho-preco">

							<span class="adicionarAoCarrinho-preco-valor" itemprop="price">
								R$ 69,90 </span> <a class="adicionarAoCarrinho-preco-frete"
								href="http://www.casadocodigo.com.br/pages/fretes"
								rel="nofollow"> + frete </a>

						</p>
				</label>
					<button class="adicionarAoCarrinho-botaoComprar" type="submit"
						name="id" value="970168053" title="Compre o Impresso">
						Comprar</button></li>
				...
				<li class="adicionarAoCarrinho-oferta" itemprop="offers" itemscope
					itemtype="http://schema.org/Offer"><label
					class="adicionarAoCarrinho-infosDaOferta"
					for="product-variant-970168065"> <span
						class="adicionarAoCarrinho-tipoDaOferta" role="presentation"
						itemprop="category"> <span
							class="adicionarAoCarrinho-tipoDaOferta-nome"> E-book +
								Impresso </span>
						...
						<p class="adicionarAoCarrinho-preco">
							...
							<span class="adicionarAoCarrinho-preco-valor" itemprop="price">
								R$ 79,90 </span> <a class="adicionarAoCarrinho-preco-frete"
								href="http://www.casadocodigo.com.br/pages/fretes"
								rel="nofollow"> + frete </a>
					...
					<button class="adicionarAoCarrinho-botaoComprar" type="submit"
						name="id" value="970168065" title="Compre o E-book + Impresso">
						Comprar</button></li>
		...
		<section class="conteudoDoLivro infoSection" itemprop="description">
			...
			<p class="infoSection-texto">Voc&#234; &#233; um programador com
				boa flu&#234;ncia em Java? Est&#225; na hora de dar mais um passo.</p>
			...
			<p class="infoSection-texto">Quase 20 anos ap&#243;s sua primeira
				vers&#227;o, um novo Java surge com novidades importantes. Entre os
				principais recursos, a linguagem recebe default methods, method
				references e lambdas. S&#227;o conceitos simples, mas que trazem
				importantes possibilidades. Durante o livro, exploraremos esses e
				outros avan&#231;os. Sempre com exemplos pr&#225;ticos e
				apresentando onde utiliz&#225;-los, migrando o c&#243;digo legado do
				dia a dia para o novo paradigma funcional do Java 8.</p>
			...
			<p class="infoSection-texto">Com esse trip&#233; de conceitos, a
				API conseguiu evoluir de uma maneira interessante. Os pacotes
				java.util.stream e java.util.function ser&#227;o explorados com
				profundidade, apresentando formas sucintas para trabalhar com
				cole&#231;&#245;es e outros tipos de dados. Streams e Collectors
				far&#227;o parte da sua rotina e ser&#227;o t&#227;o essenciais nas
				suas aplica&#231;&#245;es quanto j&#225; s&#227;o as Collections e o
				java.io.</p>
			...
			<p class="infoSection-texto">Por &#250;ltimo, veremos como a nova
				API de java.time vem mudar da &#225;gua pro vinho a forma de
				trabalhar com datas e hor&#225;rios.</p>
			...
			<p class="infoSection-texto">Ainda curioso para entender melhor
				as possibilidades? Se queremos ordenar todos os usu&#225;rios de uma
				List por pontos, e filtrar apenas os que possuem mais de 100,
				far&#237;amos assim no Java 7:</p>
			...
			<p class="infoSection-texto">
			<p class="book-description">&#201; o problema vertical do Java!
				Muito c&#243;digo de boilerplate para uma transforma&#231;&#227;o
				simples. Como fica no Java 8?</p>
			</p>
			...
			<p class="infoSection-texto">
			<p class="book-description">O livro vai muito mais longe na
				manipula&#231;&#227;o de cole&#231;&#245;es e datas. Conhe&#231;a e
				comece a utilizar as novidades em seu projeto.</p>
			</p>
			...
			<p class="infoSection-texto">
				...
				<a class="conteudoDoLivro-link" href="/pages/sumario-java8">veja
					o sumário completo</a>
		...
		<section class="autoresDoLivro infoSection">
			<h2 class="infoSection-titulo">Autores</h2>


			<div class="autoresDoLivro-autor" itemprop="author" itemscope
				itemtype="http://schema.org/Person">

				<img class="autoresDoLivro-autor-foto" itemprop="image"
					src="//cdn.shopify.com/s/files/1/0155/7645/files/paulo-silveira.png?1057931688501172147?v=2016-01-24"
					title="Foto de Paulo Silveira">
				<!--
			-->
				<h3 class="autoresDoLivro-autor-nome" itemprop="name">Paulo
					Silveira</h3>
				<p class="infoSection-texto autoresDoLivro-autor-descricao"
					itemprop="description">
					<strong>Paulo Silveira</strong>, <a rel="nofollow"
						href="http://twitter.com/paulo_caelum" target="_blank">@paulo_caelum</a>,
					&#233; bacharel e mestre em Ci&#234;ncia da Computa&#231;&#227;o
					pela USP, possui mais de 10 anos de experi&#234;ncia com
					desenvolvimento, passando pela Alemanha e pelo IBOPE. Coordena os
					cursos da Caelum nos cursos de ver&#227;o da USP. Um dos fundadores
					do GUJ.com.br e &#233; editor t&#233;cnico da revista Mundo Java.
			...
			<div class="autoresDoLivro-autor" itemprop="author" itemscope
				...
				<img class="autoresDoLivro-autor-foto" itemprop="image"
					src="//cdn.shopify.com/s/files/1/0155/7645/files/rodrigo-turini.png?1057931688501172147?v=2016-01-24"
					title="Foto de  Rodrigo Turini">
				<!--
			-->
				<h3 class="autoresDoLivro-autor-nome" itemprop="name">Rodrigo
					Turini</h3>
				<p class="infoSection-texto autoresDoLivro-autor-descricao"
					itemprop="description">
					<strong>Rodrigo Turini</strong> &#233; Bacharel em Ci&#234;ncia da
					Computa&#231;&#227;o, desenvolvedor, instrutor pela Caelum e autor
					de cursos do Alura. Desenvolve sistemas principalmente em Java e
					atualmente participa do expert group que mant&#233;m a JSR 371
					(Model-View-Controller) e JSR 370 (JAX-RS 2.1), sendo a primeira
					uma nova especifica&#231;&#227;o do JavaEE 8. Rodrigo tem
					participa&#231;&#227;o ativa na comunidade, participando de
					diversas listas de discuss&#245;es sobre linguagens e frameworks, e
					tendo palestrado em eventos no Brasil e exterior, como DevCamp 2013
					e JavaOne 2014, em San Francisco. &#201; um dos l&#237;deres de
					desenvolvimento do VRaptor e contribui para diversos outros
					projetos open source. Gosta de estudar continuamente as melhores
					pr&#225;ticas da orienta&#231;&#227;o a objetos,
					programa&#231;&#227;o funcional e Java 8.
				</p>
			</div>
		...
		<section class="infosAdicionaisDoLivro infoSection">
			...
			<dl class="infosAdicionaisDoLivro-info">
				...
				<dt class="infosAdicionaisDoLivro-info-titulo">Data de
					publicação:</dt>
				<dd class="infosAdicionaisDoLivro-info-valor">03/2014</dd>
			</dl>
			<div class="infosAdicionaisDoLivro-links" role="presentation">
				<a class="infosAdicionaisDoLivro-button"
					href='http://erratas.casadocodigo.com.br/'> Submeter errata </a> <a
					class="infosAdicionaisDoLivro-button" rel="nofollow"
					href='http://forum.casadocodigo.com.br'
					title="Ir para fórum de discussões"> Fórum de discussões </a>
			</div>
		</section>
			 ...
			 -->
				<section class="rodape-secao rodape-secaoLinks">
					...
					<ul>
						...
						<li class="rodape-item"><a class="rodape-itemLink"
							href="/pages/sobre-a-casa-do-codigo"> Sobre a Casa do Código
						</a></li>
						...
						<li class="rodape-item"><a class="rodape-itemLink"
							href="http://www.caelum.com.br"> Caelum Ensino e Inovação </a></li>
				...
				<section class="rodape-secao rodape-secaoOutros">
					...
					<ul>
						<li class="rodape-formaDePagamento"><img
							src="//cdn.shopify.com/s/files/1/0155/7645/t/189/assets/pagseguro.png?1057931688501172147"
							border="0" alt="pag seguro" /></li>
						<li class="rodape-formaDePagamento"><img
							src="//cdn.shopify.com/s/files/1/0155/7645/t/189/assets/paypal.png?1057931688501172147"
					...
					<ul>
						<li class="rodape-item rodape-redeSocial"><a
							...
							title="Casa do Código no Facebook" rel="nofollow"
	...
	<script type="text/javascript"
		src="//cdn.shopify.com/s/files/1/0155/7645/t/189/assets/trackExternalLinks.js?1057931688501172147"></script>
