            ...
            <section class="conteudoDoLivro infoSection" itemprop="description">
                ...
                <div class="imagemLivroNinja " role="img">
                    ...
                    <div class="imagemLivroNinja-tablet" style="" role="presentation">
                        ...
                        <image xlink:href="//cdn.shopify.com/s/files/1/0155/7645/products/G8Odq4Q1TChRM5NMkpWOfJLrIdpMhXpIMt0Qs0vOAJQ_size_mode_2_size_1024x768_large.jpeg?v=1447444684" x="17" y="27" height="185" width="146" preserveAspectRatio="xMidYMin slice" />
                        </g>
                        </svg>
                    </div>
                    <div class="imagemLivroNinja-cel" style="" role="presentation">
                        ...
                        <image xlink:href="//cdn.shopify.com/s/files/1/0155/7645/products/G8Odq4Q1TChRM5NMkpWOfJLrIdpMhXpIMt0Qs0vOAJQ_size_mode_2_size_1024x768_large.jpeg?v=1447444684" x="4.90685927" y="24.0532818" height="122.5551362" width="75.20674853" preserveAspectRatio="xMidYMin slice" />
                    ...
                    <ul class="adicionarAoCarrinho-listaOfertas">
                        ...
                        <c:forEach items="${produto.precos}" var="preco">
                            <li class="adicionarAoCarrinho-oferta" itemprop="offers" itemscope >
                                <label class="adicionarAoCarrinho-infosDaOferta" for="product-variant-10263481793">
                                    <input type="radio" name="tipo" class="variant-radio"
                                           id="tipo" 
                                           value="${preco.tipoPreco}" 
                                           checked />
                                ...
                                <button class="adicionarAoCarrinho-botaoComprar" 
                                        type="submit" name="id" value="10263481793" title="${produto.titulo}">
                                    Comprar
                                </button>
                            </li>
                        </c:forEach>
